...
summon item ~ ~.5 ~ {Tags:["q.ExchangeBook"],PickupDelay:3,Item:{id:"amethyst_shard",Count:1b,tag:{Enchantments:[{}],q.Key:true,display:{Name:'{"text":"Demonic Key","italic": false}',Lore:['{"text":"Throw this onto a locked object to open it!"}']}}}}
