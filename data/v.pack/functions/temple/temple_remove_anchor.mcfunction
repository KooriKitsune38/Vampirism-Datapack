...
# Kill Everything
kill @s
kill @e[tag=v.AnchorStand,distance=..3]
kill @e[tag=v.templePart,distance=..5]
kill @e[tag=v.templePart4,distance=..5]
kill @e[tag=v.templePart4b,distance=..5]
...
playsound minecraft:entity.fox.screech block @a ~ ~ ~ 2 0.8
playsound minecraft:entity.fox.screech block @a ~ ~ ~ 2 0.5
