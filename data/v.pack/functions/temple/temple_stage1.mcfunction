...
#summon marker ~ ~1 ~ {Marker:1b,Small:1b,Invisible:1b,Tags:["v.templePart"]}

## Effects ##
tellraw @a[distance=..50] {"text":"Vampire Ritual Initialized","color":"#c17171","bold":true}
effect give @a[distance=..50,predicate=!v.pack:player/is.vampire] minecraft:blindness 5 0
