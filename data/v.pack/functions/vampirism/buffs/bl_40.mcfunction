...
execute at @e[distance=.1..10,predicate=!v.pack:player/dark_vision_exeptions,predicate=v.pack:world/is_dark1] run particle minecraft:soul_fire_flame ~ ~0.5 ~ 0.2 0.3 0.2 0 1 force @a[predicate=v.pack:player/is.vampire]
