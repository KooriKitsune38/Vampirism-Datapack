...
# Nerfs
effect give @a[distance=..5,predicate=v.pack:player/is.vampire,nbt=!{active_effects:[{id:"minecraft:hunger", amplifier:0b}]}] hunger 5 1 true
effect give @a[distance=..5,predicate=v.pack:player/is.vampire] slowness 1 0 true
effect give @a[distance=..3,predicate=v.pack:player/is.vampire,nbt=!{active_effects:[{id:"minecraft:wither", amplifier:0b}]}] weakness 1 0 true
