...
execute at @s run summon item ~ ~ ~ {Item:{id:"minecraft:blaze_rod",Count:1b,tag:{display:{Name:'{"text":"Hell Wand","color":"#FF0000","italic":false}',Lore:['{"text":"Use this to do various spooky stuff.","color":"gray","italic":false}']},HellWand:1b,Enchantments:[{}]}}}