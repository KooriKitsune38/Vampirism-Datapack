...
execute if entity @s[predicate=v.pack:chance_20] run particle end_rod ~ ~ ~ .15 .15 .15 0.02 2 force
...
execute as @a[scores={qwuthaltptimer=100..}] run function v.pack:broken_temple/qwuthal_portal/teleport_to_qwuthal