...
# Bat
#> Summon
execute if entity @s[tag=!t.transformed] run summon bat ~ ~ ~ {Tags:[t.bat],ActiveEffects:[{Id:11,Amplifier:127b,Duration:-1,ShowParticles:false}],Attributes:[{Name:"generic.movement_speed",Base:0}]}
#> Transfer UUID
