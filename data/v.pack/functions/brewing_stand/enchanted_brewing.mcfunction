...
## Enchanted Brew
execute if entity @s[scores={brewingtimer=3600}] run function v.pack:brews/enchanted_brew

## Particles ##
execute if entity @s[scores={brewingtimer=1..800},predicate=v.pack:chance_50] at @s run particle minecraft:dust 0.259 0 0.11 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
execute if entity @s[scores={brewingtimer=801..1600},predicate=v.pack:chance_50] at @s run particle minecraft:dust 0.408 0.004 0.204 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
execute if entity @s[scores={brewingtimer=1600..2400},predicate=v.pack:chance_50] at @s run particle minecraft:dust 0.675 0 0.282 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
execute if entity @s[scores={brewingtimer=2401..3601},predicate=v.pack:chance_50] at @s run particle minecraft:dust 0.886 0 0.369 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
