...
## BrewingResults
execute if entity @s[scores={brewingtimer=2400}] run function vampire_pack:brews/blood_brew

## Particles ##
execute if entity @s[scores={brewingtimer=1..800},predicate=vampire_pack:chance_50] run particle minecraft:dust 0.259 0 0 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
execute if entity @s[scores={brewingtimer=801..1600},predicate=vampire_pack:chance_50] run particle minecraft:dust 0.58 0.008 0.008 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
execute if entity @s[scores={brewingtimer=1600..2401},predicate=vampire_pack:chance_50] run particle minecraft:dust 0.914 0 0 0.5 ~ ~0.5 ~ 0.2 0.2 0.2 0 3 normal
