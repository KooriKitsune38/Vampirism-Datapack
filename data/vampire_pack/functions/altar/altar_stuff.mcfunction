# Timers
scoreboard players add @s altarsoundtimer 1
execute if score @s altarsoundtimer matches 600.. run scoreboard players reset @s altarsoundtimer
...
# Sounds
execute if score @s altarsoundtimer matches 50 run playsound minecraft:block.beacon.ambient ambient @a ~ ~ ~ 0.3 2
