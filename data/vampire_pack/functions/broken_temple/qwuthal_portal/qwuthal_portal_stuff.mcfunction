...
execute if entity @s[predicate=vampire_pack:chance_20] run particle end_rod ~ ~ ~ .15 .15 .15 0.02 2 force
...
execute as @a[scores={qwuthaltptimer=100..}] run function vampire_pack:broken_temple/qwuthal_portal/teleport_to_qwuthal
