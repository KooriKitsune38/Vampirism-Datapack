execute if entity @s[predicate=!vampire_pack:player/tag_vampire,scores={spoopytimer=1230..1235}] run playsound minecraft:entity.fox.screech hostile @s ~ ~ ~ 0.5 0.6
