...
execute as @s[tag=TempleStage4] run execute as @a[distance=..7,predicate=!vampire_pack:player/tag_vampire] unless entity @s[scores={vampirismtimer=1..}] run effect give @s blindness 2 0
