...
# Kill Everything
kill @s
kill @e[type=armor_stand,tag=AnchorStand,distance=..3]
kill @e[type=armor_stand,tag=ArmorStandParticles,distance=..5]
kill @e[type=armor_stand,tag=ArmorStandParticles4,distance=..5]
kill @e[type=armor_stand,tag=ArmorStandParticles4b,distance=..5]
...
effect give @a[distance=..7,predicate=!vampire_pack:player/tag_vampire] blindness 30 0
...
## Advancements ##
advancement grant @a[distance=..7] only vampire_pack:temple/break_temple